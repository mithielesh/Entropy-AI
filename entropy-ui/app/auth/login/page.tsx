...
export default function LoginPage() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    router.push('/dashboard'); // We will build this route later
  };
  ...
  return (
    <div className="min-h-screen bg-[#030303] text-white flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
         ...
         <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-purple-900/20 blur-[120px] rounded-full" />
      </div>
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm mt-2">Enter your credentials to access the neural net.</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div className="space-y-1">
             <div className="flex justify-between items-center ml-1">
                ...
                <span className="text-[10px] text-purple-400 hover:text-purple-300 cursor-pointer">Forgot?</span>
             </div>
            <div className="relative group">
          ...
          <button 
            type="submit"
            className="w-full py-3 bg-white text-black font-bold rounded-lg hover:bg-gray-200 transition-transform active:scale-95 flex items-center justify-center gap-2 mt-4"
          >
        ...
        <div className="relative my-8">
           ...
           <div className="relative flex justify-center text-xs uppercase"><span className="bg-[#0A0A0A] px-2 text-gray-600">Or continue with</span></div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
           ...
           <button className="flex items-center justify-center gap-2 py-2.5 bg-white/5 hover:bg-white/10 border border-white/10 rounded-lg transition-colors text-sm">
             <GoogleIcon className="w-5 h-5" /> {/* Icon added here */}
        ...
        <p className="text-center text-gray-500 text-xs mt-8">
          New to the system?{' '}
          <Link href="/auth/signup" className="text-purple-400 hover:text-white transition-colors underline">

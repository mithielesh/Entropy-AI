    ...
    <div className="min-h-screen bg-[#030303] text-white flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm mt-2">Enter your credentials to access the terminal.</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div className="space-y-1">
            <div className="flex justify-between items-center px-1">
              ...
              <a href="#" className="text-[10px] text-purple-400 hover:text-purple-300">Forgot Key?</a>
            </div>
            <div className="relative group">
        ...
        <div className="relative my-8">
           ...
           <div className="relative flex justify-center text-xs uppercase"><span className="bg-black/50 backdrop-blur-xl px-2 text-gray-500">Or access with</span></div>
        </div>
